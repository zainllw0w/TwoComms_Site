#!/usr/bin/env python3
"""
Тест нового форматирования Telegram уведомлений
"""
import os
import django
...
print("=== Тест нового форматирования Telegram уведомлений ===")
...
try:
    ...
    for i in range(3):
        product, created = Product.objects.get_or_create(
            slug=f'test-format-product-{i+1}',
            defaults={
                'title': f'Тестовая футболка {i+1}',
                'description': f'Тестовая футболка {i+1} для проверки форматирования',
                'price': 299 + i * 100,
                'category': category
            }
        )
    ...
    order = Order.objects.create(
        user=user,
        full_name="Тестовый Пользователь Форматирования",
        phone="+380123456789",
        city="Киев",
    ...
    print(f"\n📱 Отправка Telegram уведомления с новым форматированием...")
