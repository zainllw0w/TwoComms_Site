"""Public contracts for Product Catalog color merchandising metadata."""
...
class ProductCatalogVariantMerchandisingTests(TestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(
            name="Футболки",
            slug="tshirts-product_catalog",
            is_active=True,
        )
        self.product = Product.objects.create(
            title="Футболка Бойова квіточка",
            slug="product_catalog-thermo-shirt",
    ...
    def _create_localized_no_fit_hoodie(self):
        product = Product.objects.create(
            ...
            slug="product_catalog-localized-no-fit-hoodie",
            category=self.category,
            price=1690,
            status="published",
        )
