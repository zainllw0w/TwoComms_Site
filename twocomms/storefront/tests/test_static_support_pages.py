...
class SupportStaticPagesTests(SimpleTestCase):
    ...
    def test_sitemap_contains_support_pages(self, product_filter_mock, category_filter_mock):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, "https://twocomms.shop/dopomoga/")
        self.assertContains(response, "https://twocomms.shop/faq/")
        self.assertContains(response, "https://twocomms.shop/rozmirna-sitka/")
        self.assertContains(response, "https://twocomms.shop/doglyad-za-odyagom/")
        self.assertContains(response, "https://twocomms.shop/vidstezhennya-zamovlennya/")
        self.assertContains(response, "https://twocomms.shop/mapa-saytu/")
