...
class ProductDetailTests(ProductViewTestCase):
    ...
    def test_product_detail_renders_single_share_action_and_delivery_tab(self):
        ...
        self.assertContains(response, 'product-detail.css?v=20260804-gallery-v4', html=False)
        self.assertContains(response, 'product-media-fit.css?v=20260804-gallery-v4', html=False)
        self.assertContains(response, 'product-reviews.css?v=20260511-pdp-layout-v8', html=False)
        self.assertContains(response, 'product-detail.js?v=20260804-gallery-v4', html=False)
        self.assertContains(response, 'product-media-fit.js?v=20260804-gallery-v4', html=False)
