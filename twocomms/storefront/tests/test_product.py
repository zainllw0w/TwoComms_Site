...
class ProductDetailTests(ProductViewTestCase):
    ...
    def test_product_detail_renders_single_share_action_and_delivery_tab(self):
        ...
        self.assertContains(response, 'product-detail.css?v=20260808-merch-v1', html=False)
        ...
        self.assertContains(response, 'product-detail.js?v=20260808-merch-v1', html=False)
