...
class ProductConfiguratorRenderTests(TestCase):
    ...
    def test_versioned_pdp_assets_use_one_fresh_release_key(self):
        ...
        self.assertIn("css/product-detail.css?v=20260804-gallery-v3", html)
        self.assertIn("css/product-media-fit.css?v=20260804-gallery-v3", html)
        self.assertIn("css/product-seo-landing.css?v=20260716-pdp-v2", html)
        self.assertIn("js/product-detail.js?v=20260804-gallery-v3", html)
        self.assertIn("js/product-media-fit.js?v=20260804-gallery-v3", html)
