...
WHOLESALE_FAQ_ITEMS = [
    {
        ...
        'answer': _('Оптові партії стартують від 8 одиниць. Ми допомагаємо зібрати асортимент під магазин, шоурум, команду або локальний бренд.'),
    },
    {
        'question': _('Чи можна отримати фіксовані ціни для дропшиперів?'),
        'answer': _('Так. Для дропшипінгу та постійних партнерів фіксуємо прайс і формат роботи після узгодження умов та асортименту.'),
    },
    {
        'question': _('Як швидко відвантажуються оптові замовлення?'),
        'answer': _('Після підтвердження складу й замовлення ми готуємо партію, оформлюємо документи та передаємо відправку по Україні у погоджений дедлайн.'),
    },
]
...
COOPERATION_FAQ_ITEMS = [
    {
        ...
        'answer': _('Ми працюємо з дропшипінгом, оптовими закупівлями, бренд-партнерствами, дизайнерами, блогерами та медіа.'),
    },
    {
        'question': _('Кому підійде сторінка співпраці?'),
        'answer': _('Сторінка підходить магазинам, шоурумам, брендам, дизайнерам, контент-кріейторам і командам, які хочуть запускати спільні проєкти або продавати TwoComms.'),
    },
    {
        'question': _('Куди звертатися для старту співпраці?'),
        'answer': _('Найшвидший шлях — написати в Telegram або перейти в оптовий чи кастомний сценарій, якщо вам потрібен конкретний формат запуску.'),
    },
]
