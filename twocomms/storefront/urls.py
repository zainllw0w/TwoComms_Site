...
urlpatterns = [
    ...
    path('offer/<uuid:proposal_id>/status/', _module_view('storefront.views.ig_checkout', 'ig_checkout_status'), name='ig_checkout_status'),
    ...
    # catalogs CRUD
    path('admin-panel/catalog/categories/new/', views.admin_category_new, name='admin_category_new'),
    path('admin-panel/catalog/categories/<int:pk>/edit/', views.admin_category_edit, name='admin_category_edit'),
    path('admin-panel/catalog/categories/<int:pk>/delete/', views.admin_category_delete, name='admin_category_delete'),
