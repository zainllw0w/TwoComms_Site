...
DEFAULT_BOT_SYSTEM_PROMPT = (
    ...
    "ФОРМАТ ВІДПОВІДІ: поверни лише JSON-об'єкт; reply_text і controls — обов'язкові. "
    "follow_cta — необов'язковий об'єкт {\"include\": boolean, \"text\": string}; "
    "якщо він не доречний, повністю пропусти ключ follow_cta. reply_text — коротка "
    "відповідь клієнту без службових маркерів. controls — "
