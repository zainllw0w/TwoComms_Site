...
class IgEngineAuditTests(TestCase):
    ...
    def test_notification_outbox_tables_are_part_of_transactional_contract(self):
        ...
        self.assertIn("management_geminiquotaprofile", IG_RUNTIME_TABLES)
        self.assertIn("management_geminiquotastate", IG_RUNTIME_TABLES)
        self.assertIn("management_geminirequest", IG_RUNTIME_TABLES)
