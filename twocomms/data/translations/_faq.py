...
ANSWERS: dict[str, dict[str, str]] = {
    ...
    "Виверніть навиворіт, прийте при 30 °C у режимі для бавовни без відбілювачів. Сушіть на повітрі. Прасувати можна з вивороту або через марлю.": {
        "ru": "Выверните наизнанку, стирайте при 30 °C в режиме для хлопка без отбеливателей. Сушите на воздухе. Гладить можно с изнанки или через марлю.",
        "en": "Turn inside out, wash at 30 °C on a cotton cycle without bleach. Air-dry only. Iron inside out or through cheesecloth.",
    },
