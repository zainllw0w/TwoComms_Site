...
MATERIAL_PARAGRAPH = {
    "tshirt": {
        "uk": "Виготовлена зі щільного бавовняного трикотажу 180–220 г/м²: не просвічується, добре тримає форму після прання, м'яка до шкіри. Принт нанесено методом DTF-друку — насичені кольори та тонкі деталі.",
        "ru": "Изготовлена из плотного хлопкового трикотажа 180–220 г/м²: не просвечивает, хорошо держит форму после стирки, мягкая к коже. Принт нанесён методом DTF-печати — насыщенные цвета и тонкие детали.",
        "en": "Built from dense cotton jersey at 180–220 g/m²: opaque, holds its shape after washing, soft to the skin. The print is applied by DTF printing — saturated colours and fine detail.",
    },
    "hoodie": {
