...
POLICY_TABLE = "fable5_productinventorypolicy"
...
def backfill_product_inventory_policies(apps, schema_editor):
    ...
    ProductInventoryPolicy = apps.get_model("fable5", "ProductInventoryPolicy")
    VariantBlankLink = apps.get_model("fable5", "VariantBlankLink")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("fable5", "0007_product_option_axis_presentation"),
    ]
