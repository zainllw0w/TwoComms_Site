...
DB_PASSWORD=***REMOVED_SSH_PASSWORD***
DB_HOST=localhost
DB_PORT=3306
```
...
- Проверьте правильность пароля `***REMOVED_SSH_PASSWORD***`
...
- Проверьте, что пароль `***REMOVED_SSH_PASSWORD***` правильный
