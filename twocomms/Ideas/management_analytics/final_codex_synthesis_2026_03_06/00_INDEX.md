...
- `09_RESEARCH_QUESTIONS_FOR_DEEP_AGENT.md` — полноценный русскоязычный brief для deep-research агента: контекст проекта, стартовые числа, границы исследования, карта файлов и 5 приоритетных вопросов под TwoComms Management.
