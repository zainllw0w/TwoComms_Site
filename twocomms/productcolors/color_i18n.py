...
COLOR_I18N: Dict[str, Dict[str, str]] = {
    ...
    "зелена":         {"uk": "Зелена",        "ru": "Зелёная",       "en": "Green"},
    ...
    "термо-зелена":   {"uk": "Термо-зелена",  "ru": "Термо-зелёная", "en": "Thermo green"},
    "термо-зелений":  {"uk": "Термо-зелений", "ru": "Термо-зелёный",  "en": "Thermo green"},
    "термо-зеленая":  {"uk": "Термо-зелена",  "ru": "Термо-зелёная", "en": "Thermo green"},
    "термо-зеленый":  {"uk": "Термо-зелений", "ru": "Термо-зелёный",  "en": "Thermo green"},
