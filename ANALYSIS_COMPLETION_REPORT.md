...
```bash
# Деплой инструментов
/opt/homebrew/bin/sshpass -p '***REMOVED_SSH_PASSWORD***' scp -o StrictHostKeyChecking=no *.py qlknpodo@195.191.24.169:/home/qlknpodo/TWC/TwoComms_Site/twocomms/tools/

# Запуск анализа на сервере
/opt/homebrew/bin/sshpass -p '***REMOVED_SSH_PASSWORD***' ssh -o StrictHostKeyChecking=no qlknpodo@195.191.24.169 "bash -lc 'source /home/qlknpodo/virtualenv/TWC/TwoComms_Site/twocomms/3.13/bin/activate && cd /home/qlknpodo/TWC/TwoComms_Site/twocomms && python tools/run_full_analysis.py'"

# Скачивание результатов
/opt/homebrew/bin/sshpass -p '***REMOVED_SSH_PASSWORD***' scp -o StrictHostKeyChecking=no qlknpodo@195.191.24.169:/home/qlknpodo/TWC/TwoComms_Site/twocomms/*_performance_analysis.json .
```
