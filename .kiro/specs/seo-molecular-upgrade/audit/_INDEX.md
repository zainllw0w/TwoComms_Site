# Deep SEO Audit — Workstream Index

Это индекс параллельных аудит-задач, которые выполняются субагентами и
синтезируются потом в `SEO_DEEP_AUDIT_2026-05-16.md`.
...
| 7 | 2026 SEO + AI search best practices | general-task-execution | `audit/07_best_practices_2026.md` | queued |

## Synthesis target

`/Users/zainllw0w/TwoComms/site/.kiro/specs/seo-molecular-upgrade/SEO_DEEP_AUDIT_2026-05-16.md`

После завершения всех 7 — на основе фактуры формируется список вопросов
владельцу, потом пишется `requirements.md`.
