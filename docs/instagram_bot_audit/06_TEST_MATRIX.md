...
| T12 | Follow-up payment link | GREEN | provider-evidenced delivery FSM plus materialized event continuation: 254 focused event/FSM/checkout/restock tests and production `13bedf8f` |
