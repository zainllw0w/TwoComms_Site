...
| База внедрения | Кодовый срез `1380db8e` подтверждён на production; последующие восстановительные коммиты меняют только документацию |
| **Статус 88 IMP-задач** | **63 закрыты, 23 открыты, 2 частично закрыты (`IMP-043`, `IMP-077`)** |
...
| `07_IMPLEMENTATION_PLAN.md` | канонический статус всех 88 IMP-задач: 63 закрыты / 23 открыты / 2 partial |
...
| Статус | Задачи |
|---|---|
| Открыто, W4B | `IMP-051`, `IMP-053`, `IMP-055`–`IMP-058` |
| Открыто, W5 | `IMP-028` |
