...
| База внедрения | `d0098d0b` подтверждён в `origin/main` и на production; включает fulfillment IMP-055, durable claims IMP-056 и lifecycle возражений IMP-057 поверх IMP-051/053 |
| **Статус 96 IMP-задач** | **68 закрыты, 26 открыты, 2 частично закрыты (`IMP-043`, `IMP-077`)** |
...
| Реестр находок | **166 уникальных `F-*` идентификаторов**; добавлены F-OBJ-006…008, повторные записи сохраняют историю проверки и закрытия |
...
| `03_FINDINGS_REGISTER.md` | 166 уникальных `F-*` и post-implementation evidence, включая production SQL/API |
...
| `07_IMPLEMENTATION_PLAN.md` | канонический статус всех 96 IMP-задач: 68 закрыты / 26 открыты / 2 partial |
