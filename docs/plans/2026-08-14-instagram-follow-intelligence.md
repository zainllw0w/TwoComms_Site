...
- [x] Record rejected findings with evidence. Evidence: validated local defects were fixed; remaining open items are the consented Graph probe, calibration, privacy retention/biometric policy hardening, unrelated migration drift, and current deployment-log proof.
